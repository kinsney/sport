...
class Bike(models.Model):
    ...
    hourRent = models.IntegerField(u'每小时租金',blank=True,null=True)
    dayRent = models.IntegerField(u'每天租金',blank=True,null=True)
    weekRent = models.IntegerField(u'每周租金',blank=True,null=True)
